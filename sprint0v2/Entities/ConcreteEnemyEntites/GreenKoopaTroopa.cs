...
namespace sprint0v2.Entities.ConcreteEnemyEntites
{
    public class GreenKoopaTroopa : Enemy
    {
        ...
        public GreenKoopaTroopa(Vector2 position, Vector2 speed)
            : base(position, speed)
        {
            _currentState = new KoopaNormalState(this);
            Sprite = EnemySpriteFactory.Instance.CreateSprite(Position, (int)EnemySpriteFactory.eEnemySprite.GreenKoopaTroopa);
