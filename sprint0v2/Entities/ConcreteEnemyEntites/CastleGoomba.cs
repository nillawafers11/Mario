...
{
    public class CastleGoomba : Enemy
    {
        ...
        public CastleGoomba(Vector2 position, Vector2 speed)
            : base(position, speed)
        {
            Sprite = EnemySpriteFactory.Instance.CreateSprite(Position,(int)EnemySpriteFactory.eEnemySprite.CastleGoomba);
