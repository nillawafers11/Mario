...
{
    public class CastleBrick : Block
    {
        public CastleBrick(Vector2 position) : base(position, Vector2.Zero, ItemType.Nothing, 0, false) 
        {
            Sprite = BlockSpriteFactory.Instance.CreateSprite(position, (int)BlockSpriteFactory.eBlockSprite.CastleBrick);
